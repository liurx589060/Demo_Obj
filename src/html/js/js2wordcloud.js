	...
	(function () {
	  ...
	  (function (global) {
	    ...
	    var WordCloud = function WordCloud(elements, options) {
	      ...
	      var getTextInfo = function getTextInfo(word, weight, color,rotateDeg) {
	      ...
	      var drawText = function drawText(gx, gy, info, word, weight, distance, theta, rotateDeg, attributes) {
	        ...
	        }else if("undefined" != typeof info.fontColor) {
	      ...
	      var putWord = function putWord(item) {
	        var word, weight, attributes,color;
	        ...
	        var info = getTextInfo(word, weight,color, rotateDeg);
